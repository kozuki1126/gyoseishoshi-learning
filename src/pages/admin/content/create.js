...
export default function CreateContent() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setMessage({ type: 'success', text: 'コンテンツを保存しました' });
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="space-y-6">
                    ...
                    <label htmlFor="audio-upload" className="cursor-pointer">
                      {formData.audioFile ? (
                        ...
                        <div className="text-gray-500">
                          ...
                          <p className="text-xs text-gray-400 mt-1">MP3, WAV (50MB以下)</p>
                        </div>
                      )}
                    </label>
                  </div>
                    ...
                    <label htmlFor="pdf-upload" className="cursor-pointer">
                      {formData.pdfFile ? (
                        ...
                        <div className="text-gray-500">
                          <Upload className="w-6 h-6 mx-auto mb-2" />
                          <span className="text-sm">クリックしてアップロード</span>
                          <p className="text-xs text-gray-400 mt-1">PDF (10MB以下)</p>
                        </div>
                      )}
                    </label>
                  </div>
            ...
            <div className="bg-blue-50 rounded-xl p-4">
              <h4 className="text-sm font-medium text-blue-800 mb-2">Markdownの使い方</h4>
